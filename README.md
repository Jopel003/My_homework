...
3. Создан репозитарий на GitHub.
4. Подключена синхронизация с VS Code, файл с кодом размещен в репозитарии
...
### Результаты:  
   ...
   2. Файл с кодом размещен в репозитарии, открывается.
